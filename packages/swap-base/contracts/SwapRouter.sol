    ...
    SelfPermit
{
    ...
    function retrievePool(
        ...
        return ISwapiiPool(PoolAddress.calculatePoolAddress(s.factory, PoolAddress.getPool(tokenA, tokenB, fee)));
    }
...
//Redundant code
        ...
        returns (uint256 amountIn)
    {
        ...
        s.amountInCached = LibAppStorage.DEFAULT_AMOUNT_IN_CACHED;
    }
